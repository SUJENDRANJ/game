...
export default function AchievementsManager() {
  ...
  const rarities = [
    ...
    { value: 'legendary', label: 'Legendary', color: 'from-yellow-400 to-orange-500' }
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-800">Achievements Manager</h2>
          <p className="text-gray-600">Create and manage achievements for all users</p>
        </div>
        <button
        ...
        {achievements.map(achievement => (
          ...
          >
            <div className="flex items-start gap-3">
              <div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${rarityColors[achievement.rarity]} flex items-center justify-center flex-shrink-0`}>
      ...
      {achievements.length === 0 && !showForm && (
        <div className="bg-white rounded-2xl p-12 text-center shadow-lg">
          ...
          <p className="text-gray-600">Create your first achievement to get started!</p>
        </div>
      )}
    </div>
  );
