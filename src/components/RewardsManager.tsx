...
export default function RewardsManager() {
  ...
  const categories = [
    { value: 'time_off', label: 'Time Off', icon: Clock, color: 'from-blue-500 to-blue-700' },
    { value: 'perks', label: 'Perks', icon: Star, color: 'from-purple-500 to-purple-700' },
    { value: 'swag', label: 'Swag', icon: Gift, color: 'from-pink-500 to-pink-700' },
    { value: 'experiences', label: 'Experiences', icon: Sparkles, color: 'from-orange-500 to-red-600' }
  ];
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Create and manage rewards for the marketplace</p>
        </div>
        <button
      ...
      {rewards.length === 0 && !showForm && (
        <div className="bg-white rounded-2xl p-12 text-center shadow-lg">
          ...
          <h3 className="text-xl font-bold text-gray-800 mb-2">No Rewards Yet</h3>
          <p className="text-gray-600">Create your first reward to populate the marketplace!</p>
        </div>
      )}
    </div>
  );
